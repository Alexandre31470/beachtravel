...
<header>
		<div class="title-header">
			...
			<a href="../../pages/accueil/accueil.php"><img src="../../pictures/pngegg.png" alt="logo" title="Ceci est mon logo"></a>
		</div>
		<nav>
			<ul>
				<li><a class="navbar" href="../../pages/accueil/accueil.php">Accueil</a></li>
				<li><a class="navbar" href="../../pages/articles/ajoutArticle.php">Ajout Article</a></li>
				<li><a class="navbar" href="../../pages/form/formulaire.php">Réservations</a></li>
				<li><a class="navbar" href="../../pages/accueil/page-contact.php">Contact</a></li>
				<li><a class="navbar" href="../../pages/connexion/login.html">Connexion</a></li>
			</ul>
		</nav>
	</header>
<body>
